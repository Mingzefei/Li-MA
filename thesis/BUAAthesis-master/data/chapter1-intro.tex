...
金属电极与电解液之间复杂的界面反应，以及循环中形成的“死锂”(图\ref{fig:Li-anode}a)\upcite{huaApplicationComputationalSimulation2020}会导致电池容量下降，降低电池效率。
这些都阻碍了锂金属电极的应用范围。

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{Li-andoe.jpg}
