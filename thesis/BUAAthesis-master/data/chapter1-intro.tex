...
以 \ce{CH3NH3PbI3}（结构如图\ref{fig:temp-struc}所示）为例，温度变化时，晶格中的\ce{PbI3}八面体会发生旋转和倾斜，从而产生不同的相：低温时为正交相；温度高于约 \SI{162}{K} 时为四方相；温度高于约 \SI{330}{K} 时为立方相\upcite{liRecentProgressOrganohalide2015}。
